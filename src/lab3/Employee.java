...
public class Employee {
    ...
    private ReportService systemOutput;
    ...
    */
    ...
    private void meetDepartmentStaff() {
        metDeptStaff = true;
        systemOutput.systemOutput(firstName + " " + lastName + " met with Dept. Staff on "
            + getFormattedDate());
    }
    ...
    public void reviewDeptPolicies() {
        ...
        systemOutput.systemOutput(firstName + " " + lastName + " reviewed Dept policies on "
            + getFormattedDate());
    }
    ...
    public void moveIntoCubicle(String cubeId) {
        this.cubeId = cubeId;
        this.movedIn = true;
        systemOutput.systemOutput(firstName + " " + lastName + " moved into cubicle "
